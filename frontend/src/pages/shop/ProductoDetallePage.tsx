...
export function ProductoDetallePage() {
  ...
  const cargarProducto = async (productoId: number) => {
    ...
    try {
      ...
      // Cargar reseñas después de tener el producto
  ...
  const precioActual = producto.precio_actual || producto.precio_venta;
  const stockDisponible = producto.stock_disponible || 0;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="mb-4">
            {tieneDescuento ? (
              <div>
                <span className="text-3xl font-bold text-blue-600">S/ {precioActual.toFixed(2)}</span>
